...
RealGrid에서 포커스셀은 커서가 위치한 셀을 의미합니다. 포커스셀의 정보를 가져오려면 [GridBase.getCurrent()](http://help.realgrid.com/api/GridBase/getCurrent/)를 이용하고 포커스셀의 정보를 입력하려면 [GridBase.setCurrent()](http://help.realgrid.com/api/GridBase/setCurrent/)를 이용합니다.  
...
2. 버튼을 클릭하면 toggleFocus()함수를 실행합니다.
